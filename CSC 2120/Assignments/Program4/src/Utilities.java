    ...
    public static boolean invalidDate(String date) {
        ...
        try {
            if (date.length() == 8) {
               ...
               if (month >= 1 && month <= 12 && day >= 1 && day <= 28 && year >= 0 && year <= 99) {
                   result = false;
               }
               if ((day == 29 || day == 30) && (month == 4 || month == 6 || month == 9 || month == 11) && year >= 0 && year <= 99) {
                   result = false;
               }
               if (day == 29 && month == 2 && year >= 0 && year <= 99 && year % 4 == 0) { // leap year
                   result = false;
               }
